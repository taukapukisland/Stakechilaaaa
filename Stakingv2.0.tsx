...
import { NFT, prepareContractCall, sendTransaction, createThirdwebClient, getContract  } from "thirdweb";
import { useEffect, useState } from "react";
import { getNFTs, ownerOf, totalSupply, claimTo, isERC721, getOwnedNFTs, startTokenId } from "thirdweb/extensions/erc721";
import { NFTCard } from "./NFTCard";
import { getOwnedERC721s } from "./getOwnedERC721s";
import { owner } from "thirdweb/modules";
...
export const Staking = () => {
   ...
   const getOWnedNFTs = async () => {
    ...
    const contract = getContract({
        client,
        chain: chain,
        address: "0x41860523F4e5C817ca397C4610Ddea36b8af5254",
      });
